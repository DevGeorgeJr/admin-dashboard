      ...
      >
        ...
        >
          <div className="grid lg:grid-cols-3 grid-cols-1 gap-4 w-full mb-4">
            <div className="w-full flex flex-col justify-center items-center bg-blue-200 p-5 rounded-xl gap-5 transition-transform transform hover:scale-105 cursor-pointer">
            ...
            <div className="w-full flex flex-col justify-center items-center bg-red-200 p-5 rounded-xl gap-5 transition-transform transform hover:scale-105 cursor-pointer">
              <div className="w-full flex justify-between items-center">
            ...
            <div className="w-full flex flex-col justify-center items-center bg-green-200 p-5 rounded-xl gap-5 transition-transform transform hover:scale-105 cursor-pointer">
              <div className="w-full flex justify-between items-center">
        ...
        <div id="right"  className="p-2 flex flex-col justify-center items-center gap-4 h-full">
          <div id="top" className="bg-slate-100 p-8 w-full rounded-xl flex flex-col justify-center items-center gap-6 h-fit">
            <div id="image-box" className="w-full flex flex-col justify-center items-center gap-4">
              <img src={client} alt="client-iamge" className="rounded-full w-[100px] h-[100px]"/>
          ...
          <div id="bottom" className="bg-slate-800 w-full h-full p-6 rounded-xl flex flex-col justify-center items-center gap-8">
            <div className="flex md:flex-row flex-col justify-between items-center w-full gap-2">
              ...
              <button className="bg-green-600 text-white px-6 rounded-xl cursor-pointer text-md">Active</button>
            </div>
            ...
            <div className="flex justify-between items-center w-full h-fit flex-col md:flex-row gap-4">
              ...
              <div className="flex flex-col justify-center items-start gap-1">
                <h1 className="text-white text-2xl font-bold">11,129</h1>
