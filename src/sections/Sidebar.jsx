...
export const Sidebar = () => {
  ...
  return (
    <motion.section
      ...
      variants={variants}
      className={
        "w-1/5 bg-slate-800 h-screen flex flex-col justify-between items-center gap-10 relative " +
    ...
    >
      <div className="flex flex-col justify-center items-center gap-8">
        {isExpanded ? (
          <div id="logo-box">
            <h1 className="text-red-600 font-bold text-4x1">
        ...
        >
          {navItems.map((item, index) => (
            ...
            >
              <div className="bg-amber-100 text-black p-2 rounded-full">
                <item.icon className="md:w-6 w-4 h-4 md:6" />
              </div>
